...
export default function GigCard({ gigId }) {
    ...
    return (
        <>
            <div className="">
                <div className="flex flex-col md:flex-row relative z-2 justify-between px-5 md:px-10 py-12 h-[72rem] md:h-[36rem] mx-auto w-[25rem] md:w-[60rem] bg-[#ffffff]  border-4 rounded-[5px] drop-shadow-[10px_10px_0px_rgba(0,0,0,1)]">

                    <div className="flex flex-col justify-around font-mada font-medium text-[3rem] text-center md:text-left">
